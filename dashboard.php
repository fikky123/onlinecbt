  ...
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-quarter">
      <div class="w3-container w3-card w3-white w3-round w3-margin">
        ...
        <a href="stresstest.php" class="w3-button">Let's go!</a>
      </div>
    </div>
    <div class="w3-quarter">
      <div class="w3-container w3-card w3-white w3-round w3-margin">
        <div class="w3-center"><i class="fa fa-file w3-xxxlarge"></i></div>
        <div class="w3-center">
          <h3>CBT Lessons</h3>
        </div>
        <div class="w3-clear"></div>
        <a href="cbtlessons.php" class="w3-button">Let's go!</a>
      </div>
    </div>
    <div class="w3-quarter">
      <div class="w3-container w3-card w3-white w3-round w3-margin">
        <div class="w3-center"><i class="fa fa-star w3-xxxlarge"></i></div>
        <div class="w3-center">
          <h3>Relaxation Tips</h3>
        </div>
        <div class="w3-clear"></div>
        <a href="relaxtips.php" class="w3-button">Let's go!</a>
      </div>
    </div>
    <div class="w3-quarter">
      <div class="w3-container w3-card w3-white w3-round w3-margin">
        <div class="w3-center"><i class="fa fa-comment w3-xxxlarge "></i></div>
        <div class="w3-center">
          <h3>Comments</h3>
        </div>
        <div class="w3-clear"></div>
        <a href="viewcomment.php" class="w3-button">Let's go!</a>
      </div>
    </div>
  </div>
  <br>
