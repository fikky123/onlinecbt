...
<div class="w3-container w3-padding-64 w3-center" id="stresstest">
 <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> CBT Lessons</b></h5>
  </header>
	  
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-quarter">
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        <div class="w3-center"><i class="fa fa-edit w3-xxxlarge"></i></div>
        <div class="w3-center">
          <h3>Lesson 1</h3>
		  <p> Introduction</p>
        </div>
        <div class="w3-clear"></div>
        <a href="lesson1.php" class="w3-button w3-border">Let's go!</a><br><br>
      </div>
    </div>
    <div class="w3-quarter">
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <div class="w3-center">
          <h3>Lesson 2</h3>
		  <p>Taking an Axe to Anxiety </p>
        </div>
        <div class="w3-clear"></div>
		<a href="worksheet2-1.php" class="w3-button w3-border">Worksheet 2-1</a><br><br>
        <a href="lesson2.php" class="w3-button w3-border">Let's go!</a><br><br>
      </div>
    </div>
    <div class="w3-quarter">
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <div class="w3-clear"></div>
		<a href="worksheet3-1.php" class="w3-button w3-border">Worksheet 3-1</a><br><br>
        <a href="lesson3.php" class="w3-button w3-border">Let's go!</a><br><br>
      </div>
    </div>
	</div>
	</div>
